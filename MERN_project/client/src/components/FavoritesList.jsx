...
<div class="section_our_solution">
        ...
        <div className="our_solution_category">
            ...
            <div className="solution_card">
                ...
                <p>{art.description}</p>
                <a style={{marginRight:"20px", marginBottom:"50px"}} href={`/articles/${art._id}`} ><button type="button" className="read_more_btn">Details</button></a>
                <DeleteButton articleId={art._id} removeFromDom={removeFromDom} style= {{marginTop: "20px"}} type="button" class="read_more_btn">Unfavorite</DeleteButton>
