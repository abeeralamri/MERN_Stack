        ...
        <form style = {{textAlign : "center"}} onSubmit={onSubmitHandler}>
            <h1>Product Manager</h1>
                <div className="form-group">
                    <span style = {{width : "400px", height :"80px" , marginLeft : "350px", marginTop : "50px" , backgroundColor :"#F6F6F6"}}  className="input-group-text" >
               ...
               <div className="form-group">
                ...
                <button style = {{marginTop : "30px",}} type="submit" className="btn btn-light">Create</button>
